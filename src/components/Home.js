    ...
    <div className="home container d-flex align-items-center justify-content-center">
      <div className="row">
        ...
        <div className="col-lg-6 glassbg">
          <h1 className="text-white text-center">Sapphy Doyle</h1>
          <br></br>
          ...
          {showTick ? (
            <h3 className="text-center  resume-download mt-5">
              <FontAwesomeIcon icon={faCheck} /> Download complete
            </h3>
          ) : (
            <h3 className="text-white text-center mt-5" onClick={handleDownload}>
